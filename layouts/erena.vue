<template>
  <div class="
    ...
    <!--bg-svg-light-sm
      ...
      dark:bg-svg-dark-sm
      dark:md:bg-svg-dark-->
    <div :class="`inset-0 w-full fixed h-full -z-50 block pointer-events-none bg-gray-200 dark:bg-abyss-1100`">
      <svg
        width="100%"
        height="100vh"
        class="absolute -z-40"
    ...
    <ErenaHeader :title="nuxtApp._route.path.split('/').reverse()[0] || 'home'" />
    <div class = "inset-0 w-full fixed h-full -z-10 block pointer-events-none dark:bg-abyss-1100/50 bg-gray-300/50" />
