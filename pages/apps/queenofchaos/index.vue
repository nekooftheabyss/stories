<template>
  <div class="flex-1 w-full max-w-6xl p-4 mx-auto md:px-8 md:py-16">
    <div class="bg-opacity-20 bg-grayshit-600 text-white">
      <p class="text-md font-semibold px-8 pb-2 pt-8 tracking-wide leading-9">Anime battles with special abilities with unique traits! One bot to get memes, search anime/manga, get cute animals and get boorus! What's more, a cool anime/meme themed PvP game!</p>
      <p class="text-md font-semibold px-8 py-2 tracking-wide leading-9">A <span class="line-through">multipurpose</span> bot for your server! Don't forget to join our support server for frequent giveaways and event info!</p>

      <div class="container mx-auto grid-cols-1 md:grid-cols-2 grid">
        <div class="mx-auto w-full max-w-md p-4">
          <NuxtLink to="/apps/queenofchaos/invite"
        ...
        <div class="mx-auto w-full max-w-md p-4">
          <a href="https://discord.gg/A69vvdK"
                    class="block text-center mx-auto w-full max-w-full font-bold text-white px-4 py-3 transition duration-300 ease-in-out bg-zinc-800 bg-opacity-80 hover:bg-zinc-700 text-white">Join Kuroneko's Server!</a>
        </div>
      </div>

    </div>

    <div class="p-8 pt-3 text-white md:bg-opacity-80">

      <div class="grid grid-cols-1 md:grid-cols-3">
        <div class="p-4 mx-auto">
          <a href="https://top.gg/bot/679741957047582725"
             target="_blank">
            <img src="https://top.gg/api/widget/679741957047582725.svg"
                 alt="Kuroneko-sama's Widget Failed to Load" />
          </a>
        </div>
        <div class="p-4 mx-auto">
          <a href="https://discords.com/bots/bot/679741957047582725"
             target="_blank">
            <img src="https://discords.com/bots/api/bot/679741957047582725/widget"
                 title="Visit Kuroneko listed on Bots for Discord!"
      ...
      <hr class="bg-kuro-300 bg-kuro-300 border-kuro-300 border-2 rounded-md" />

      <div class="bg-opacity-20 bg-grayshit-600 grid grid-cols-1 md:grid-cols-2">
        <div class="p-4">
        ...
        <div class="p-4">
          <img src="/queen/example1.png"
               title="Roleplay Commands"
               alt="Kuroneko-sama's Example Failed to Load"
